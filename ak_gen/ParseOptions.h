...
AK_DEFINE_OPTION_WITH_MULTIPLE_VALUES( SourcesOp, SOURCES_OP_ID, "source-path,s", "source-path",
      "Sets source paths to iterate over. This option can be used multiple times", std::string );
...
AK_DEFINE_OPTION_WITH_UNIQUE_VALUE( MediaOp, MEDIA_OP_ID, "media", "media", "Media to search for", std::string, "audio" ) 

AK_DEFINE_OPTION_WITH_UNIQUE_VALUE( ChunkNumberOp, CHUNK_NUMBER_OP_ID, "chunk-number", "chunk number", 
      "Number of chunk files to process in a group. Default is 50", int, 50 ) 
