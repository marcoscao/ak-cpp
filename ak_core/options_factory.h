#ifndef AK_CORE_OPTIONS_FACTORY_H__
#define AK_CORE_OPTIONS_FACTORY_H__
...
namespace ak {
	...
	template<typename T, T_CREA >
	class factory : public factory_base {
	public:
	   virtual void register_item( int id, std::unique_ptr< T_CREA > )
	   {
	   }

	   virtual std::weak_ptr< item > create( int id )
	   {
	   }
