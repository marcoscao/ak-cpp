...
class PO {
public:
        typedef tuple< string, string > OptDef;
        typedef vector< OptDef > OptDefList;
...
private:
        ...
        po::options_description op_desc_;
        po::positional_options_description positional_op_desc_;
...
int main(int argc, char** argv) {
        ...
        PO::OptDefList g{
                PO::OptDef{ "help,h", "help usage info" },
                PO::OptDef{ "verbose,v", "verbose mode" },
                PO::OptDef{ "dry_run", "dry run mode" }
        };
